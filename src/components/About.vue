      ...
      <div class="about">
        ...
        <p>
          ...
          <ul>
            ...
            <li>クラスの有利/不利によるバフ・デバフ、マスタークラス特性によるバフ、スターフォースクエストのアタック/マジックバフなども全て加算の関係。</li>
          </ul>
          <br />
          つまり、大雑把には<br />
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              クリティカルダメージ倍率は 30% + バフ効果量。
              <ul>
                <li>クリティカル発生率は テクニック÷10 + クリティカル率バフ - 相手のクリティカル率耐性 とみられる。</li>
                <li>
                  ただし、サポートはクリティカルが発生することはない模様。<br />
                  <span class="note">ユニット対象バフでクリティカル率100%にしてもサポートのダメージにクリティカルダメージ倍率が適用されない。</span>
                </li>
              </ul>
            </li>
