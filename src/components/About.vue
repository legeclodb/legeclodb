      ...
      <div class="about">
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li class="note">ただし、タレントのダメージ耐性持ちにダメージ耐性デバフをかけた場合掛け算になるように見られる。いろんなケースで要検証。</li>
              </ul>
            </li>
          </ul>
          <br />
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              ダメージ耐性バフ・デバフと与ダメージバフ・デバフは掛け算の関係。<br />
              <span class="note">ダメージ耐性バフと与ダメージデバフは 70% が上限で、両方最大まで盛ると 0.3×0.3=9% まで被ダメージを抑え込める。</span>
            </li>
